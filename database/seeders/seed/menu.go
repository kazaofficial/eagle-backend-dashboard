...
func MenuSeeders() {
	...
	menus := []entity.Menu{
		...
		{
			ID:          34,
			Name:        "Daftar Penarikan Data",
			Description: "Daftar Penarikan Data menu",
			ParentID:    &penarikanDataID,
			UrlKey:      "manajemen-data-proses,penarikan-data,daftar-penarikan-data",
			Url:         "/manajemen-data-proses/penarikan-data/daftar-penarikan-data",
			Icon:        "fluent:arrow-sync-circle-24-filled",
		},
		{
			ID:          35,
			...
			Url:         "/manajemen-data-proses/penarikan-data/tambah-penarikan-data",
			Icon:        "fluent:arrow-sync-circle-24-filled",
		},
		{
			ID:          36,
